...
class MainActivity : AppCompatActivity() , DeleteAndUpdate {
    lateinit var  database : DatabaseReference
    var todoList : MutableList<ModelActivity>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener{view ->
            ...
            alertDialog.setPositiveButton("Add"){ dialog, i ->
                val todoItemData = ModelActivity.createList()
        ...
        todoList = mutableListOf<ModelActivity>()
        adapter = AdapterActivity(this, todoList!!)
