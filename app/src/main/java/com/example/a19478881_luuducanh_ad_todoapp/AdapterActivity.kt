...
class AdapterActivity(context : Context , todoList : MutableList<ModelActivity>) : BaseAdapter() {
    private val inflater:LayoutInflater = LayoutInflater.from(context)
    private var itemList = todoList
    private var deleteAndUpdate : DeleteAndUpdate = context as DeleteAndUpdate
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        viewHolder.isDone.setOnClickListener {
            deleteAndUpdate.modifyItem(UID, !done)
        }
        viewHolder.isDeleted.setOnClickListener {
            deleteAndUpdate.onItemDelete(UID)
        }
